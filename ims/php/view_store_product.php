...
<head>
    ...
    <title>IMS - View stored products</title>
...
<body>
    ...
    color: rgb(129, 85, 2); margin-left: 5px; font-weight:bold;text-decoration:underline;">Stored product table: </h3>
            ...
            <table style="margin:30px">
                ...
                <?php
                    ...
                    while($data = mysqli_fetch_array($query)){
                        $show_id = $data['store_product_id'];
                        $show_p_id = $data['product_id'];
                        $show_name = $data['product_name'];
                        $show_code = $data['store_product_quantity'];
                        ...
                        echo "<tr>
                            ...
                            <td>$show_code</td>
                            <td>$show_date</td>
                            <td><a href='editStoreProduct.php?name=$show_p_id'>Edit</a></td>
                        </tr>";

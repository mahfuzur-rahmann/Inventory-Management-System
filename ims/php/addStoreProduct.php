...
<head>
    ...
    <title>IMS - Add products in store</title>
...
<body>
    ...
    color: rgb(129, 85, 2); margin-left: 5px; font-weight:bold;text-decoration:underline;">Add new product: </h3>
                        ...
                        <form style="margin-left:10px" action="addStoreProduct.php">
                        ...
                        <?php
                            ...
                            if(isset($_GET['product_category'])){
                                ...
                                // $sql_2 = "SELECT product_id FROM store_product WHERE product_id='$product_category' ";
                                ...
                                //     else{
                                        ...
                                        $sql  ="INSERT INTO store_product(product_id,product_name,store_product_quantity,store_product_entry_date) VALUES ('$product_category', '$p_name','$product_code', '$product_entry_date')";
